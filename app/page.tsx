...
export default function Home() {
  ...
  const handleSpotifySubmit = (spotifyUrl: string) => {
    sessionStorage.setItem('spotifyUrl', spotifyUrl);
    router.push(createPageUrl("Player") + "?mode=spotify");
  };
    ...
    <LayoutWrapper>
      <div className="min-h-screen flex items-center justify-center p-6 overflow-hidden">
        ...
        <div className="fixed inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-indigo-200 rounded-full blur-3xl breathing-animation" style={{animationDelay: "2s"}}></div>
          <div className="absolute top-1/2 right-1/3 w-32 h-32 bg-purple-200 rounded-full blur-3xl breathing-animation" style={{animationDelay: "3s"}}></div>
        </div>
        ...
        <div className="w-full max-w-2xl mx-auto relative z-10 mt-16 sm:mt-0">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-xl text-gray-600 mb-2 font-light">
              Discover the feelings hidden in your favorite music
            </p>
          </div>
          ...
          <div className="glass-morphism-light rounded-3xl p-6 sm:p-8">
            {activeTab === "upload" ? (
              ...
              <SpotifyInput onSpotifySubmit={handleSpotifySubmit} />
            )}
          </div>

          <div className="text-center mt-8">
            <p className="text-gray-500 text-sm">
              Experience your music in a whole new dimension
            </p>
          </div>
        </div>
      </div>
