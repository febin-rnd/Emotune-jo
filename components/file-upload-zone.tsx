  ...
  return (
    <div
      ...
      className={`relative border-2 border-dashed rounded-2xl p-8 sm:p-12 transition-all duration-300 cursor-pointer ${
        dragActive ? "border-primary bg-indigo-100/50" : "border-border hover:border-primary hover:bg-indigo-50/50"
      }`}
    ...
    >
      ...
      <div className="text-center">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-3">Drop your audio file here</h3>

        <p className="text-gray-500 mb-6 text-lg">
          {dragActive ? "Release to start the magic!" : "Drag & drop MP3, WAV, or other audio files"}
        </p>
