        ...
        >
          {isStatic ? (
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-700">Now Playing on Spotify</h3>
              <p className="text-gray-500 mt-2">View the song&apos;s overall emotion profile above. <br/>For line-by-line analysis, please upload an MP3 file.</p>
            </div>
          ) : (
            <>
              ...
              <div className="mb-6">
                ...
                <div className={`w-20 h-1 bg-gradient-to-r ${getEmotionClasses(emotion.emotion)} rounded-full mx-auto mt-4 opacity-50`}></div>
              </div>
              
              <div className={`inline-flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r ${getEmotionClasses(emotion.emotion)} font-semibold text-lg shadow-md mb-6 bg-opacity-50`}>
